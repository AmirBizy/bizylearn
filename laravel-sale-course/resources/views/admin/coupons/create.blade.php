                        			...
                        			<div class="row">
                        				...
                        				<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code" value="{{ old('code') }}" class="form-control" id="exampleInputEmail1" placeholder="کد تخفیف را وارد کنید">
                                            </div>
                        				</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="percent_off" value="{{ old('percent_off') }}" class="form-control" id="exampleInputEmail1" placeholder="درصد تخفیف را وارد کنید">
                                            </div>
                        				</div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="تاریخ انقضا را انتخاب کنید" id="expireInput" name="expires_at" value="{{ old('expires_at') }}">
