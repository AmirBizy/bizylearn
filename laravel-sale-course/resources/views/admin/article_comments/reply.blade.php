                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                                    <form role="form" action="{{ route('admin.article-reply-comment-post' , ['comment' => $comment->id]) }}" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    @method('PUT')
                        			<div class="row">
                                        @if(count($errors) > 0)
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"> پاسخ به دیدگاه کاربر: <span class="text-primary">{{ $comment->userArticleComment->name }}</span></label>
