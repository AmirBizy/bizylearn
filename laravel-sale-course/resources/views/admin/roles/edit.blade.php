                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                                    <form role="form" action="{{ route('admin.roles.update' , ['role' => $role->id]) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                        			<div class="row">
                                        @if(count($errors) > 0)
                        				...
                        				<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="exampleInputEmail1" value="{{ $role->name }}" {{ old('name') }}>
                                            </div>
                        				</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="display_name" class="form-control" id="exampleInputEmail1" value="{{ $role->display_name }}" {{ old('display_name') }}>
                                            </div>
                        				</div>
